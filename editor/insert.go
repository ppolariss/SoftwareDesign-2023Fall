...
func (c *InsertCommand) Execute() error {
	var err error
	c.lineNum, err = Insert(c.lineNum, c.content, &workspace.CurWorkspace.FileContent)
	return err
}
...
func (c *AppendHead) Execute() error {
	...
	_, err := Insert(1, c.content, &workspace.CurWorkspace.FileContent)
	return err
}
...
func (c *AppendTail) Execute() error {
	var err error
	c.lineNum, err = Insert(-1, c.content, &workspace.CurWorkspace.FileContent)
	return err
}
